            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><a href="{{URL::to('/admin/categories/add')}}" class="btn btn-success">Thêm mới</a></h3>
                        <div class="box-tools">
                        ...
                        <table class="table table-hover">
                            <tbody>
                                <tr>
                                    ...
                                    <th>{{adminSort("Tên chuyên mục","name")}}
                                    </th>
                                    <th>{{adminSort("Loại","category_type")}}
                                    </th>
                                    <th>Sắp xếp
                                    </th>
                                    <th>Link
                                ...
                                <tr>
                                    ...
                                    <td><a href="/admin/categories/edit/{{$category->id}}" class="btn btn-primary">Sửa</a>

                                        <a href="/admin/categories/delete/{{$category->id}}" onclick="return confirm('Bạn có chắc muốn xóa')" class="btn btn-default">Xóa</a>
                                    </td>
                                </tr>
                                @endforeach
                    ...
                    <div class="box-footer clearfix">
                       <?php echo $categories->appends(Input::only('search','option','per_page','sort','order'))->links(); ?>
                    </div>
                </div>
                <!-- /.box -->
            </div>
