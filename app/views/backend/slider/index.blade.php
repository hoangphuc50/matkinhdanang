            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><a href="{{URL::to('/admin/sliders/add')}}" class="btn btn-success">Thêm mới</a></h3>
                        <div class="box-tools">
                            <form action="/admin/sliders" method="get">
                    ...
                    <div class="box-body table-responsive no-padding">
                        ...
                        <table class="table table-hover slider-table">
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       {{HTML::image(sliderImageFolder().$slider->image,'')}}
                                       @endif
                                    </td>
                                    <td>{{$slider->name}}
                                    </td>
                                    ...
                                    <td>
                                        @if($slider->highlight == true)
                                        <span class="label label-danger">Nổi bật</span>
                                        @endif
                                    </td>
                                    
                                    <td><a href="/admin/sliders/edit/{{$slider->id}}" class="btn btn-primary">Sửa</a>

                                        <a href="/admin/sliders/delete/{{$slider->id}}" onclick="return confirm('Bạn có chắc muốn xóa')" class="btn btn-default">Xóa</a>
                                    </td>
                                </tr>
                                @endforeach
                    ...
                    <div class="box-footer clearfix">
                       <?php echo $sliders->appends(Input::only('search','option','per_page','sort','order'))->links(); ?>
                    </div>
                </div>
                <!-- /.box -->
            </div>
